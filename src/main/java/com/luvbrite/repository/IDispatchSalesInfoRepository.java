...
public interface IDispatchSalesInfoRepository {
	...
	boolean updateDispatchSalesInfo(RoundTripDistanceDTO roundTripDistanceDetails, DispatchUpdateDTO dispatchUpdateDTO,
			String discountString, int shopId) throws Exception;
