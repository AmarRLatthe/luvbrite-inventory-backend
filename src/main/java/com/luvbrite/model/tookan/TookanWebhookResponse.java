...
public class TookanWebhookResponse {
    ...
    public String toString() {
        return "TookanWebhookResponse{" + "job_id=" + job_id + ", order_id=" + order_id + ", team_id=" + team_id + ", job_hash=" + job_hash + ", job_description=" + job_description + ", customer_email=" + customer_email + ", customer_phone=" + customer_phone + ", job_address=" + job_address + ", creation_datetime=" + creation_datetime + ", fleet_id=" + fleet_id + ", customer_id=" + customer_id + ", fleet_name=" + fleet_name + ", fleet_email=" + fleet_email + ", fleet_phone=" + fleet_phone + ", task_history=" + task_history + ", job_state=" + job_state + ", task_state=" + task_state + ", completed_datetime_formatted=" + completed_datetime_formatted + ", started_datetime_formatted=" + started_datetime_formatted + ", arrived_datetime_formatted=" + arrived_datetime_formatted + ", acknowledged_datetime_formatted=" + acknowledged_datetime_formatted + ", job_token=" + job_token + ", job_time_formatted=" + job_time_formatted + ", total_time_spent_at_task_till_completion=" + total_time_spent_at_task_till_completion + ", job_pickup_datetime_formatted=" + job_pickup_datetime_formatted + ", job_delivery_datetime_formatted=" + job_delivery_datetime_formatted + ", total_distance=" + total_distance + ", webhook_type=" + webhook_type + ", format=" + format + ", template_key=" + template_key + ", is_internal=" + is_internal + ", full_tracking_link=" + full_tracking_link + '}';
    }
