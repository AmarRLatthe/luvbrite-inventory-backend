...
//    	http.authorizeRequests().anyRequest().permitAll();
    	...
    	.and()
    		...
    		.and()
    		.authorizeRequests()
    			.antMatchers("/api/shop/createShop").hasAnyRole("CHIEF","MANAGE_SHOP")
    			.antMatchers("/api/driver/createDriver").hasAnyRole("CHIEF","MANAGE_DRIVER","SHOP_CHIEF")
    			.antMatchers("/api/vendor/createVendor").hasAnyRole("CHIEF","MANAGE_VENDOR","SHOP_CHIEF")
    			...
    			.antMatchers("/api/operator/createOperator").hasAnyRole("CHIEF","SHOP_CHIEF","MANAGE_OPERATOR")
